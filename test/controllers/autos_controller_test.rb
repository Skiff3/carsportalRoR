...
class AutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auto" do
    assert_difference("Auto.count") do
      post autos_url, params: { auto: { brand: @auto.brand, desc: @auto.desc, models_name: @auto.models_name } }
    end
  ...
  test "should update auto" do
    patch auto_url(@auto), params: { auto: { brand: @auto.brand, desc: @auto.desc, models_name: @auto.models_name } }
